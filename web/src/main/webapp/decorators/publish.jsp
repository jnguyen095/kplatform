...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/layout/publish/css/style.css"/>"/>
...
<section class="home" id="home">
    <div class="row">
        ...
        <div class="image">
            <img src="<c:url value="/layout/publish/image/home-img-1.png"/>" class="main-home-image" alt="">
        </div>
    </div>

    <div class="image-slider">
        <img src="<c:url value="/layout/publish/image/home-img-1.png"/>" alt="">
        <img src="<c:url value="/layout/publish/image/home-img-2.png"/>" alt="">
        <img src="<c:url value="/layout/publish/image/home-img-3.png"/>" alt="">
    </div>
</section>
...
<section class="about" id="about">
    ...
    <div class="row">
        <div class="image">
            <img src="<c:url value="/layout/publish/image/about-img.png"/>" alt="">
        </div>
        ...
        <div class="content">
            ...
            <div class="icons-container">
                <div class="icons">
                    <img src="<c:url value="/layout/publish/image/about-icon-1.png"/>" alt="">
                    <h3>quality coffee</h3>
                </div>
                <div class="icons">
                    <img src="<c:url value="/layout/publish/image/about-icon-2.png"/>" alt="">
                    <h3>our branches</h3>
                </div>
                <div class="icons">
                    <img src="<c:url value="/layout/publish/image/about-icon-3.png"/>" alt="">
                    <h3>free delivery</h3>
                </div>
            </div>
        </div>
...
<section class="menu" id="menu">
    ...
    <div class="box-container">
        <a href="#" class="box">
            <img src="<c:url value="/layout/publish/image/menu-1.png"/>" alt="">
            <div class="content">
        ...
        <a href="#" class="box">
            <img src="<c:url value="/layout/publish/image/menu-2.png"/>" alt="">
            <div class="content">
                <h3>our special coffee</h3>
        ...
        <a href="#" class="box">
            <img src="<c:url value="/layout/publish/image/menu-3.png"/>" alt="">
            <div class="content">
                <h3>our special coffee</h3>
        ...
        <a href="#" class="box">
            <img src="<c:url value="/layout/publish/image/menu-4.png"/>" alt="">
            <div class="content">
                <h3>our special coffee</h3>
        ...
        <a href="#" class="box">
            <img src="<c:url value="/layout/publish/image/menu-5.png"/>" alt="">
            <div class="content">
                <h3>our special coffee</h3>
    ...
    <div class="swiper review-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide box">
                ...
                <img src="<c:url value="/layout/publish/image/pic-1.png"/>" alt="">
                <div class="stars">
            ...
            <div class="swiper-slide box">
                <i class="fas fa-quote-left"></i>
                <i class="fas fa-quote-right"></i>
                <img src="<c:url value="/layout/publish/image/pic-2.png"/>" alt="">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="swiper-slide box">
                <i class="fas fa-quote-left"></i>
                <i class="fas fa-quote-right"></i>
                <img src="<c:url value="/layout/publish/image/pic-3.png"/>" alt="">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="swiper-slide box">
                <i class="fas fa-quote-left"></i>
                <i class="fas fa-quote-right"></i>
                <img src="<c:url value="/layout/publish/image/pic-4.png"/>" alt="">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
...
<!-- Custom JS File Link  -->
<script src="<c:url value="/layout/publish/js/script.js"/>"></script>
